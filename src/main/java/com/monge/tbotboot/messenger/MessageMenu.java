...
public class MessageMenu {
    ...
    public void merge(MessageMenu inputMenu) {

        for (List<InlineKeyboardButton> b : inputMenu.rowList) {
            this.rowList.add(b);
        }
    ...
    public static class Button {
         ...
         * callback query to the bot when button is pressed, UTF-8 1-64 bytes.
         * If the bot instance
         */
